  ...
  Object.freeze({
    ...
    options: Object.freeze([
      Object.freeze({
        id: 'up-to-450',
        label: 'Até R$ 450 mil',
        visitorMessage: 'Até R$ 450 mil.',
        assistantMessage: 'Entendi. Você quer avançar agora ou ainda está pesquisando?',
        profile: Object.freeze({ budget: 'Até R$ 450 mil', nextAction: 'Entender momento de compra' }),
      }),
      Object.freeze({
        id: '450-to-700',
        label: 'R$ 450–700 mil',
        visitorMessage: 'Entre R$ 450 e R$ 700 mil.',
        assistantMessage: 'Perfeito. Você quer avançar agora ou ainda está pesquisando?',
        profile: Object.freeze({ budget: 'R$ 450–700 mil', nextAction: 'Entender momento de compra' }),
      }),
      Object.freeze({
        id: 'above-700',
        label: 'Acima de R$ 700 mil',
        visitorMessage: 'Acima de R$ 700 mil.',
        assistantMessage: 'Certo. Você quer avançar agora ou ainda está pesquisando?',
        profile: Object.freeze({ budget: 'Acima de R$ 700 mil', nextAction: 'Entender momento de compra' }),
      }),
    ]),
  }),
  Object.freeze({
